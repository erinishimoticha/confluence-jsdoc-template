...
var template = require('jsdoc/template'),
    ...
    wikiHelper = require('templates/confluence-jsdoc-template/templateHelper'),
...
function tutoriallink(tutorial) {
    return wikiHelper.toTutorial(tutorial, null, { tag: 'em', classname: 'disabled', prefix: 'Tutorial: ' });
}

function getAncestorLinks(doclet) {
    return wikiHelper.getAncestorLinks(data, doclet);
}
...
function generateSourceFiles(sourceFiles) {
    Object.keys(sourceFiles).forEach(function(file) {
        ...
        var sourceOutfile = wikiHelper.getUniqueFilename(sourceFiles[file].shortened);
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    var globalUrl = wikiHelper.getUniqueFilename('global');
